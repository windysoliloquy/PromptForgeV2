...
public static partial class SliderLanguageCatalog
{
        ...
        new Dictionary<string, SliderLanguageDefinition>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            [Stylization] = new(
                ...
                [
                    ...
                    Band("stylized rendering", "stylized rendering", "clear stylistic treatment", "noticeably stylized image"),
                    Band("strong stylization", "strong stylization", "boldly stylized rendering", "strong authored visual"),
                    Band("highly stylized visual", "highly stylized visual", "fully authored stylized treatment", "highly interpretive visual design"),
                ],
            ...
            [Symbolism] = new(
                ...
                [
                    Band("mostly literal", "mostly literal", "primarily literal image", "direct visual read"),
    ...
    public static string ResolvePhrase(string sliderKey, int value, PromptConfiguration configuration)
    {
        ...
        {
            return ResolveFantasyIllustrationPhrase(sliderKey, value, configuration);
        }

        if (IntentModeCatalog.IsEditorialIllustration(configuration.IntentMode))
        {
            return ResolveEditorialIllustrationPhrase(sliderKey, value, configuration);
        }
        ...
        {
            return ResolveLifestyleAdvertisingPhotographyPhrase(sliderKey, value, configuration);
        }
