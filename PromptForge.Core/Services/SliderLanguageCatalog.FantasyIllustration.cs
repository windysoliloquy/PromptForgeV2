...
public static partial class SliderLanguageCatalog
{
    ...
    private static string[] GetMagitechFantasyIllustrationBandLabels(string sliderKey)
    {
        return sliderKey switch
        {
            ...
            Whimsy => ["serious engineered tone", "light workshop play", "playful tinkering", "artificer-bent playfulness", "exuberant gadget-lore mischief"],
    ...
    private static string[] GetHighMagicFantasyIllustrationBandLabels(string sliderKey)
    {
        return sliderKey switch
        {
            ...
            Whimsy => ["serious mythic tone", "light enchanted play", "playful enchantment", "fey-charged playfulness", "exuberant magical mischief"],
    ...
    private static string[] GetLowMagicFantasyIllustrationBandLabels(string sliderKey)
    {
        return sliderKey switch
        {
            ...
            Whimsy => ["serious fireside tone", "light folktale warmth", "rustic storybook play", "superstition-tinged levity", "bold fairytale oddity"],
    ...
    private static string[] GetSharedFantasyIllustrationBandLabels(string sliderKey)
    {
        return sliderKey switch
        {
            ...
            Whimsy => ["serious tale tone", "light folktale warmth", "playful storybook energy", "trickster play", "bold fairytale mischief"],
