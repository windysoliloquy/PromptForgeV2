...
public static class LaneRegressionHarness
{
    ...
    private static IEnumerable<string> ResolveLaneDescriptors(string intentName, PromptConfiguration configuration)
    {
        return intentName switch
        {
            ...
            var mode when string.Equals(mode, IntentModeCatalog.InfographicDataVisualizationName, StringComparison.OrdinalIgnoreCase) => SliderLanguageCatalog.ResolveInfographicDataVisualizationDescriptors(configuration),
