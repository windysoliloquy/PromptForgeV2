...
public partial class WatercolorCompactManualStack : UserControl
{
    private const string LaneId = "watercolor";
    ...
    public WatercolorCompactManualStack()
    {
        InitializeComponent();
    ...
    {
        // Keep paired shared-standard sections on one namespaced key when they collapse as one spanning shell.
