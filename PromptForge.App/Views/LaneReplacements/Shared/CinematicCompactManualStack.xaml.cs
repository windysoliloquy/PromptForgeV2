...
public partial class CinematicCompactManualStack : UserControl
{
    private const string LaneId = "cinematic";
    ...
    public CinematicCompactManualStack()
    {
        InitializeComponent();
    ...
    {
        // Shared-standard compact rollouts should pair sections with one key when the collapsed shell is shared.
